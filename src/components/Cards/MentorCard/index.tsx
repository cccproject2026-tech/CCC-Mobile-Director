    ...
    if (layout === "list") {
        return (
            <Pressable style={styles.listContainer} onPress={onPress}>
                ...
                <ContactIcons small onCall={onCall} onChat={onChat} onMail={onMail} onWhatsApp={onWhatsApp} />
    ...
    return (
        <TouchableOpacity style={styles.card} activeOpacity={0.8} onPress={onPress}>
            <View style={styles.cardRow}>
                <ImageContainer src={mentor.profilePicture} size={70} />
            ...
            <ContactIcons onCall={onCall} onChat={onChat} onMail={onMail} onWhatsApp={onWhatsApp} />
        </TouchableOpacity>
    );
}
...
export const styles = StyleSheet.create({
    ...
    name: { fontSize: 18, fontWeight: "600", color: "#fff", marginRight: 6 },
    role: { fontSize: 15, color: "#fff", marginBottom: 6 },
    desc: { fontSize: 14, color: "rgba(255,255,255,0.8)", lineHeight: 20 },
