...
export default function RemoveMentorsFromMenteeScreen() {
    ...
    const handleRemove = () => {
        ...
        if (selectedMentors.length === 0) {
            Alert.alert('No Selection', 'Please select at least one mentor to remove.');
            return;
        }
                    ...
                    onPress: () => {
                        removeMutation.mutate(
                            { menteeId, mentorIds: selectedMentors },
                            {
                                ...
                                onError: () => {
                                    Alert.alert('Error', 'Failed to remove mentors. Please try again.');
                                },
                            },
                        );
                    },
                ...
                ListEmptyComponent={
                    !isLoading ? (
                        <View style={{ paddingVertical: 40, alignItems: 'center' }}>
                            <Text style={{ color: '#fff' }}>No mentors assigned to remove.</Text>
                        </View>
                    ) : null
                }
            />
            ...
            <View style={[styles.bottomContainer, { paddingBottom: bottom + 16 }]}>
                ...
                <LinearGradient
                    ...
                    style={[
                        ...
                        (selectedMentors.length === 0 || removeMutation.isPending) &&
